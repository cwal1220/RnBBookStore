...
public class RentalInfoDto {
	...
	public void setR_date(Date r_date) {
		...
		long gapMilies = r_date.getTime() - nowDate.getTime() + 1000*60*60*24*14;
		this.remDate = (int) gapMilies / (24*60*60*1000);
	}
	...
	public String toString() {
		return "RentalInfoDto [u_id=" + u_id + ", b_id=" + b_id + ", b_title=" + b_title + ", b_auth=" + b_auth
				+ ", b_pub=" + b_pub + ", b_genre=" + b_genre + ", r_date=" + r_date + ", remDate=" + remDate + "]";
	}
